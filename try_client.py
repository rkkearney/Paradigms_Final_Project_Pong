...
class GameSpace:
	    ...
	    pygame.key.set_repeat(1,50)
            self.connFact = ClientConnFactory(self)
            reactor.connectTCP("ash.campus.nd.edu", 40127, self.connFact)
            reactor.run()
	...
	def main(self):
        ...
        def addingData(self, data):
            #look up pickle
            #unpack/unload the data
            #add the data to the otherplayer and update the ball location
            pass
